...
/**
 * Thin wrapper around the Minima Core native IPC SDK (copied from minima-core-android-utxo).
 *
 ...
 *
 * Usable from an Activity or a Service: the dead-view guard only applies when the host is an
 * Activity.
 */
